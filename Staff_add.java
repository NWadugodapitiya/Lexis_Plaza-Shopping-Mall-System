...
//------------------------------------------------------------------------------------------------------------------------------
        ...
        xmain.setIcon(new ImageIcon(getClass().getResource("img/staff/Staff_add.png")));
