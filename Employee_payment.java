...
public class Employee_payment extends JFrame {
    ...
    Employee_payment(){
        ...
        payments.setBounds(382,81,142,37);
        add(payments);
...
//------------------------------------------------------------------------------------------------------------------------------
        ...
        Object[] columns = {"Shop id","Name","Rent","Status","Pay Day","Month"};
        ...
        pane.setBounds(382, 156, 1091, 898);
...
//------------------------------------------------------------------------------------------------------------------------------
        ...
        xmain.setIcon(new ImageIcon(getClass().getResource("img/Employees/Employee payment.png")));
